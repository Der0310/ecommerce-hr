  ...
  return (
    <article className='prodinfo'>
      ...
      <div className='prodinfo__container'>
        ...
        <p className='prodinfo__price'><span>Price </span><span>$ {product?.price}.00</span></p>
      ...
      <button onClick={handleBuy} className='prodinfo__btnadd'>Add to cart  <ion-icon name="cart-outline"></ion-icon></button>
