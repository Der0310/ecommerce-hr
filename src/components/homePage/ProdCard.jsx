  ...
  return (
    <article className='prodcard'>
        ...
        <ul className='prodcard__list'>
            ...
            <li className='prodcard__item'><span>Price  </span><span>$ {prod.price}.00</span></li>
        </ul>
        <div className='prodcard__buttons'>
            <button onClick={handleView}><ion-icon name="list-outline"></ion-icon></button>
            <button onClick={handleBuy}><ion-icon name="cart-outline"></ion-icon></button>
        </div>
    </article>
  )
}
